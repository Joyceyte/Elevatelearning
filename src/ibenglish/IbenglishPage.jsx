...
const IBPage = () => {
  ...
  return (
    <div className="bg-slate-50">
      {/* Hero Section */}
      <section ref={ref} className={`flex items-center py-16 px-12 `}>
        {/* Text Section */}
      ...
      >
        <h2 className="text-3xl font-bold text-[#515cb8] mb-6 text-center">
          ...
          <span className="text-[#ff3b6f]">limiting misconceptions</span>
        </h2>
      ...
      >
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-center space-x-4 space-y-8 md:space-y-0">
          ...
          {/* Review 2 */}
          <div className="flex-shrink-0 w-full md:w-1/3 p-4 bg-white rounded-lg shadow-lg flex flex-col">
            <p className="italic text-[#5c5875]">
              "Joyce is so generous with her time and knowledge, and she's done
              a superb job helping me understand GLA techniques and supporting
              me through the academic and emotional aspects of IB. (I got 92%
              for Lit)
            </p>
            <div className="flex justify-left text-[#515cb8] font-bold mt-auto">
              Rita
            </div>
            <div className="flex justify-left text-[#515cb8] font-bold">
              2023 HL (99.95 ATAR)
          ...
          <div className="flex-shrink-0 w-full md:w-1/3 p-4 bg-white rounded-lg shadow-lg">
            <p className="italic text-[#5c5875]">
              Joyce's writing formulas and constant feedback really kept me
              practicing. I’ve learned so much from you!
            </p>
            <div className="flex justify-left text-[#515cb8] font-bold">
              Jenny
            </div>
            <div className="flex justify-left text-[#515cb8] font-bold">
              2023 - 2024 SL (99.95 ATAR)
            </div>
          </div>
        </div>
      </section>
